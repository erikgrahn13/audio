...
//==============================================================================
const juce::String DenoiserAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool DenoiserAudioProcessor::acceptsMidi() const
{
...
bool DenoiserAudioProcessor::producesMidi() const
{
...
bool DenoiserAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double DenoiserAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int DenoiserAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int DenoiserAudioProcessor::getCurrentProgram()
{
    return 0;
}

void DenoiserAudioProcessor::setCurrentProgram (int index)
{
...
//==============================================================================
bool DenoiserAudioProcessor::hasEditor() const
{
...
juce::AudioProcessorValueTreeState::ParameterLayout DenoiserAudioProcessor::createParameters()
{

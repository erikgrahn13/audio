...
class StandalonePluginHolder : private AudioIODeviceCallback, private Timer, private Value::Listener
{
  public:
    ...
    */
    StandalonePluginHolder(PropertySet *settingsToUse, bool takeOwnershipOfSettings = true,
    ...
    void askUserToSaveState(const String &fileSuffix = String())
    {
        ...
        stateFileChooser->launchAsync(flags, [this](const FileChooser &fc) {
            ...
            {
                auto opts = MessageBoxOptions::makeOptionsOk(AlertWindow::WarningIcon, TRANS("Error whilst saving"),
    ...
    void askUserToLoadState(const String &fileSuffix = String())
    {
        ...
        stateFileChooser->launchAsync(flags, [this](const FileChooser &fc) {
            ...
            {
                auto opts = MessageBoxOptions::makeOptionsOk(AlertWindow::WarningIcon, TRANS("Error whilst loading"),
                                ...
                                const AudioDeviceManager::AudioDeviceSetup *preferredSetupOptions)
    {
        ...
        deviceManager.initialise(enableAudioInput ? inputChannels : 0, outputChannels, savedState.get(), true,
  ...
  private:
    ...
    */
    class CallbackMaxSizeEnforcer : public AudioIODeviceCallback
    {
      public:
                                              ...
                                              const AudioIODeviceCallbackContext &context) override
        {
            ...
            while (position < numSamples)
            {
                ...
                inner.audioDeviceIOCallbackWithContext(storedInputChannels.data(), (int)storedInputChannels.size(),
                                                       storedOutputChannels.data(), (int)storedOutputChannels.size(),
                                                       blockLength, context);
      ...
      private:
        struct GetChannelWithOffset
        {
            ...
            template <typename Ptr> auto operator()(Ptr ptr) const noexcept -> Ptr
            {
                return ptr + offset;
            }
        };

        template <typename Ptr, typename Vector> void initChannelPointers(Ptr &&source, Vector &&target, int offset)
        {
                                          ...
                                          const AudioIODeviceCallbackContext &context) override
    {
        ...
        player.audioDeviceIOCallbackWithContext(inputChannelData, numInputChannels, outputChannelData,

...
{
    public:
    SliderGroup(AudioPluginAudioProcessor& processor, juce::AudioProcessorValueTreeState& parameters, std::string_view frequencyParameterID, std::string_view gainParameterID, std::string_view QParameterID);
    ~SliderGroup();

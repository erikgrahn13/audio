...
#if /* x86_64 */ /* clang & gcc */ defined(__x86_64__) || /* msvc        */ defined(_M_AMD64)

#define ARCH_X86
#define ARCH_X86_64

#elif /* i386 */ /* clang & gcc */ defined(__i386__) || /* msvc        */ defined(_M_IX86)

#define ARCH_X86
#define ARCH_I386

#elif /* Arm64 */ /* clang & gcc */ defined(__aarch64__) || /* msvc        */ defined(_M_ARM64)

#define ARCH_ARM
#define ARCH_ARM64

#elif /* Arm */ /* clang & gcc */ defined(__arm__) || /* msvc        */ defined(_M_ARM)
